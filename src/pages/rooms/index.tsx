    ...
    return (
        <div>
            <Container>
                ...
                <Row>
                    <Col lg={8}>
                        <h1 className='h1-title mb--12'>The Galaxy Home - 1 Phòng Ngủ, 60m2, View Thành Phố, Ban Công - Dịch Vọng</h1>

                        <div className='detail__location mt--18'>
                            <BsFillGeoAltFill />
                            <span className='bold'>Cầu Giấy, Hà Nội, Vietnam</span>
                            <Link to="#map">Xem bản đồ</Link>
                        </div>
                        <div className='detail__location mt--12'>
                            <RiBuilding4Line />
                            <span className='bold'>Căn hộ dịch vụ</span>
                                ...
                                <div className='room-sidebar__wrap'>
                                    <div className="room-sidebar__pricing ">
                                        <p className="fadeIn mb--18">
                                            <span className="extra-bold">850,000₫</span>
